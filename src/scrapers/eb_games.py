...
class EBGamesScraper(BaseScraper):
    ...
    async def search_products(self, query: str) -> List[Product]:
        ...
        try:
            # Try multiple selectors as EB Games may use different structures
            product_selectors = [
                'div.product-item',
                'div.product-card',
                'article.product',
    ...
    def _parse_product_item(self, item: BeautifulSoup) -> Optional[Product]:
        ...
        try:
            ...
            name_elem = (
                ...
                item.select_one('[data-testid="product-name"]') or
                link_elem
            )
            ...
            stock_elem = (
                ...
                item.select_one('.availability') or
                item.select_one('[data-testid="stock-status"]')
            )
    ...
    async def get_product_details(self, url: str) -> Optional[Product]:
        ...
        try:
            ...
            stock_elem = (
                ...
                soup.select_one('[data-testid="stock-status"]')
            )
